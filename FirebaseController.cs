...
{
    public GameObject loginpanel, signuppanel, forgotpasswordpanel, notificationpanel, environmentselectionpanel, capsule, speedboat, notificationpanel2, notificationpanel3;
    public Camera UIcam;
    ...
    public void OpenLoginpanel()
    {
        ...
        if (Vector3.Distance(UIcam.transform.position, new Vector3(-1089, 648, -759)) > 0.1f)
        {
            UIcam.transform.position = Vector3.Lerp(UIcam.transform.position, new Vector3(-1089, 648, -759), Uicamspeed * Time.deltaTime);
        }
    }
    ...
    public void OpenSignuppanel()
    {
        ...
        forgotpasswordpanel.SetActive(false);
        environmentselectionpanel.SetActive(false);
        if (Vector3.Distance(UIcam.transform.position, new Vector3(-1680, 648, -759)) > 0.1f)
        {
            UIcam.transform.position = Vector3.Lerp(UIcam.transform.position, new Vector3(-1680, 648, -759), Uicamspeed * Time.deltaTime);
        }
    }
    ...
    public void Openforgotpanel()
    {
        ...
        environmentselectionpanel.SetActive(false);
        if (Vector3.Distance(UIcam.transform.position, new Vector3(-2362, 648, -759)) > 0.0f)
        {
            UIcam.transform.position = Vector3.Lerp(UIcam.transform.position, new Vector3(-2362, 648, -759), Uicamspeed * Time.deltaTime);
        }
    }
    ...
    public void Openselectenvironmentpanel()
    {
        ...
        if (Vector3.Distance(UIcam.transform.position, new Vector3(-1692, 648, -194)) > 0.0f)
        {
            UIcam.transform.position = Vector3.Lerp(UIcam.transform.position, new Vector3(-1692, 648, -194), Uicamspeed * Time.deltaTime);
        }
    }
    ...
    public void InitializeXR()
    {
        if (!isXRInitialized)
        {
            ...
            {
                Debug.LogError("XRGeneralSettings or Manager is not initialized.");
            }
        }
    }
